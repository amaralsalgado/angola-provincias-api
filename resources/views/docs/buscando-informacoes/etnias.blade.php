...
@section('content')
    ...
    <x-docs.section.section title="Buscando todas as etnias do país" id="buscando-todas-as-etnias-do-pais">
        ...
        <x-docs.section.paragraph>
            ...
            <x-code endpoint="/etnias"></x-code>
        </x-docs.section.paragraph>

        <x-docs.section.paragraph>
            <strong class="font-normal">Exemplo de consulta:</strong>

            <x-code :endpoint="route('api.v1.etnias')">
                {
                "success": true,
                "code": 200,
                "message": "Sucesso",
        ...
        <x-docs.section.sub-section title="Buscando uma determinada etnia" id="buscando-uma-determinada-etnia">
            <x-docs.section.paragraph>
                ...
                <x-code endpoint="/etnias/{slug}"></x-code>
            </x-docs.section.paragraph>
            ...
            <x-info>
                ...
                <br>
                <br>
                As informações de cada etnia podem ser acessadas através de um <strong>slug</strong> exclusivo que
                identifica a etnia. O <strong>slug</strong> está disponível na resposta da requisição que lista todas as
                etnias. Quando você faz uma requisição por ex. <strong>GET /etnias</strong>, a API no índice "data" retorna
                um array de objetos, e cada objeto contém o slug correspondente à etnia.
            </x-info>

            <x-docs.section.paragraph>
                <strong class="font-normal">Exemplo de consulta:</strong>

                <x-code :endpoint="config('app.api_base_url') . '/etnias/ambundu'">
                    {
                    "success": true,
                    "code": 200,
                    "message": "Sucesso",
